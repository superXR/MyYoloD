...
def detect(opt):
    ...
    ort_session = ort.InferenceSession(opt.weight, providers=['CUDAExecutionProvider'])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default="/mnt/sdb/dpai3/project/YOLOP/weights/yolop-640-640-v3.1.onnx")
    parser.add_argument('--img', type=str, default="/mnt/sdb/dpai3/project/YOLOP/inference/images/Snipaste_2022-01-07_22-23-47.png")
